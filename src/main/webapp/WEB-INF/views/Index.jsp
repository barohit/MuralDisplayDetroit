...
<body onload="getLocation()">
	...
	<div class="w3-top">
		<div class="w3-row w3-padding w3-black">
			...
			<div class="w3-col s2">
				<a href="/art_near_me" class="w3-button w3-block w3-black">MURAL
					MAP</a>
			</div>
			<div class="w3-col s3">
				<a href="/display_all_art" class="w3-button w3-block w3-black">
					DISPLAY ALL ART</a>
			</div>
			<div class="w3-col s2">
				<a href="/upload_art" class="w3-button w3-block w3-black">UPLOAD
					ART</a>
			</div>

			<div class="w3-col s3">
				<form id="checkin" action="/checkin">
					<input type="hidden" value="" name="lattitude"> <input
						type="hidden" value="" name="longitude"> <input
						type="button" onclick="submitCheckInForm()" value="CHECK IN"
	...
	<header class="bgimg w3-display-container w3-grayscale-min" id="home">
		...
		<div class="w3-display-middle w3-center">
			<span class="w3-text-white" style="font-size: 90px">the<br>Detroit
				Mural Project
			</span>
		</div>
	...
	<a href="https://www.google.com/maps/dir//${mural.address }"
		target="_blank">${mural.address }</a>
	<br>
	...
	<div class="w3-container" id="about">
		<div class="w3-content" style="max-width: 800px">
			<h5 class="w3-center w3-padding-64">
				<span class="w3-tag w3-wide">ABOUT THE APP</span>
			</h5>
			<p style="font-size: 20px" ALIGN="center">We aim to provide a
				comprehensive collection of all the murals in Detroit. Users can log
				in to save their favorites and get crowd-sourced recommendations
				based on the favorites they choose.</p>
			<div class="w3-panel w3-leftbar w3-light-grey">
				<p>
					<i>"Art is meant to be shared"</i>
				</p>
			</div>
